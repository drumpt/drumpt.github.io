...
# 앞으로 해야할 일
1. posts 본문 글꼴 변경
	- css/main.css의 body, h1,h2,h3,h4,h5,h6의 font-family에 나눔고딕 추가해서 완료.
...
1. Find markdown editor and local build system(build와 preview가 가능하면 좋을 것 같다)
	...
	- build시 한글 디렉토리를 인식하지 못하는 문제 발생
		- 해결 방법 1 : C 드라이브에 복제 폴더를 만들고, 빌드하고싶을 때마다 Microsoft SyncToy 프로그램을 실행시켜 복제 폴더를 동기화 후 빌드.
		- 해결 방법 2 : 한글 디렉토리를 인식할 수 있게 만드는 것.

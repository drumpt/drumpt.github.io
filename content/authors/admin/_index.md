...
I am a Ph.D. student in [**Computer Science**](https://www.cs.wisc.edu/) at the [**University of Wisconsin–Madison**](https://www.wisc.edu/), where I work with [**Prof. Grigorios Chrysos**](https://grigoris.ece.wisc.edu/). Prior to that, I was a researcher at [**AITRICS**](https://aitrics.com/en/), advised by [**Prof. Eunho Yang**](https://mli.kaist.ac.kr/people/), where I also worked with [**Prof. Evan Shelhamer**](https://imaginarynumber.net/) at [**The University of British Columbia**](https://www.ubc.ca/) and [**Prof. Juho Lee**](https://juho-lee.github.io/) at [**KAIST**](https://kaist.ac.kr/en/). I received my M.S. in **Artificial Intelligence** and B.S. in **Computer Science** and **Mathematics** from [**KAIST**](https://kaist.ac.kr/en/).

My research focuses on the **algorithmic and theoretical foundations of trustworthy machine learning**, with a particular emphasis on **deep generative models**. I am particularly interested in the **theoretical understanding of generalization and hallucinations in diffusion models**, as well as in developing **trustworthy generative models for Embodied AI**, including **video generation and understanding models for perception** and **vision-language-action models for control**.